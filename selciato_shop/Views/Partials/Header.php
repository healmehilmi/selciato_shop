	...
	<div class="container">
		...
		<div class="content">
            ...
            <?php endif; ?>
						...
						src="<?php echo LoginController::getImageFromSession(); ?>" <a href="<?php echo $base; ?>">
								</a>
					...
					<ul class="sidebar">
						...
						<a href="<?php echo $base; ?>"><h3>Home</h3></a>
						</li>
						<li class="accordion__item">
						<a href="<?php echo $base; ?>products"><h3>Products</h3></a>


						</li>
						<li class="accordion__item">
						<a href="http://"><h3>Contact</h3></a>
